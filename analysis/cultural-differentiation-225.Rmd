...
rc <- select(saa34full, simulation_run_id, num_culture_regions, size_trait_space, learning_rate, innovation_rate)
full_region_count <- unique(rc)

rc_by_time <- select(saa34full, simulation_run_id, num_culture_regions, size_trait_space, learning_rate, innovation_rate, sample_time)
rc_by_time_count <- unique(rc_by_time)

rc_by_time_0.9 <- subset(rc_by_time_count, learning_rate == 0.9)

rc2 <- select(saa34fullnoinnov, simulation_run_id, num_culture_regions, size_trait_space, learning_rate, innovation_rate)
rc_noinnov <- unique(rc2)

rc3 <- select(saa34fullinnov, simulation_run_id, num_culture_regions, size_trait_space, learning_rate, innovation_rate)
rc_innov <- unique(rc3)
...
```{r culture-regions, results="asis", message=FALSE, warning=FALSE, fig.width=34}
...
ggsave("../paper/figure/size-spectrum-regions-saa34full.pdf", dpi=300)
...
```{r culture-regions-conf, results="asis", message=FALSE, warning=FALSE, fig.width=34}
...
p + facet_grid(learning_rate ~ size_trait_space, scale="free_y", as.table=FALSE)
ggsave("../presentation/images/conf-size-spectrum-regions-saa34full.pdf", dpi=300)
...
```{r culture-regions2, results="asis", message=FALSE, warning=FALSE, fig.width=34}
...
```{r culture-regions3, results="asis", message=FALSE, warning=FALSE, fig.width=34}
...
```{r culture-regions4, results="asis", message=FALSE, warning=FALSE, fig.width=34}
...
```{r time-1, results="asis", message=FALSE, warning=FALSE, fig.width=34}
...
```{r lm-1, results="asis", message=FALSE, warning=FALSE, fig.width=34}
