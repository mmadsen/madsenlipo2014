...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.4]{small-trait-high-innovation-num-configs.pdf}
...
\begin{figure}[htbp] 
	\centering
	\includegraphics[scale=0.4]{culture-count-lr04-by-traitspace-size.pdf}
