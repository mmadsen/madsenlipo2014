...
should expect a combination of factors.  The way in which individuals learn skills and information likely plays a central role, as emphasized in the "learning hypothesis" analyzed from many angles in this series [@Aoki2013Determinants-of; @Nishiaki2013Introduction].  We know that learning and teaching styles vary across human groups, and formal modeling efforts are beginning to make clear that such variation has evolutionary consequences that might lead to a rapid expansion of the human cultural repertoire [@Nakahashi2013Cultural-Evolut].  Those populations which increased the amount or effectiveness of teaching would have a fitness advantage over those who relied upon imitation and "natural pedagogy" in passing along technological and foraging knowledge [@Csibra:2011dx; @Fogarty:2011gv].  Demography and population structure would also play important roles in reinforcing the fitness differences which different learning strategies would create, as pointed out by Kuhn [-@Kuhn2013Cultural-Transm]. 
  
Sterelny [-@sterelny2012evolved, p.61] sums up this combination of factors nicely:
