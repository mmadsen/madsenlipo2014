...
* this is our ability to talk about cumulative knowledge, but in the abstract
* looks like there's a bifurcation, but *both* individual social learning rates and global innovation are key to the deeper regime.
* is there literature on the criticality of innovation to cumulative social learning?


\begin{figure}[htbp] 
\centering 
\includegraphics[scale=0.4]{figure/mean-radius-by-learning-rate-innov.pdf} 
\caption{Mean radius (i.e, depth) of trait sets, by prerequisite learning rate and global innovation rate, for population size 100.} 
\label{img:mean-radius-cultures} 
\end{figure} 


## Trait Tree Symmetries ##

* need to see other population sizes, but there's a speculative effect of narrowing here
* no clue what it means, the shape stuff is still exploratory
...
* clearly there is promise here, summarize results
* difficult models to characterize, need larger samples, metapopulations, population sizes

* longer term, more trait relations, realistic trait models
...
[^expense]:  The simulations reported here ran on a cluster of 4 compute-optimized "extra large" Linux instances on Amazon's EC2 computing cloud, for a total of 17 days of wall clock time, and roughly 1500 CPU hours.  We plan further optimizations to the simulation code to make larger samples economically feasible.  
